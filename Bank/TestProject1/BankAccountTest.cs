...
namespace TestProject1
{
    ...
    public class BankAccountTest
    {
        ...
        {
            BankAccount target = new BankAccount("Mr. Bryan Walton", 11.99); // TODO: инициализация подходящего значения
            double amount = 11.22; // TODO: инициализация подходящего значения
            target.Debit(amount);
            Assert.AreEqual(0.77, Convert.ToDouble(target.Balance), 0.05);
        }
        ...
        public void CreditTest()
        {
            ...
            Assert.AreEqual(23.21, Convert.ToDouble(target.Balance), 0.05);
        }
